  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="flex h-full max-h-[calc(100vh-200px)] min-h-[600px] overflow-hidden rounded-lg border bg-background">
        ...
        <div
          className={`w-100 shrink-0 border-r bg-background ${isSidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}lg:relative fixed inset-y-0 left-0 z-50 transition-transform duration-300 ease-in-out lg:block`}
        >

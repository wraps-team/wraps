...
/**
 * Segment error boundary for /segments (audit findings F6 and F19).
 *
 * `page.tsx` already turns a failed `listSegments` into an in-place error
 * state without ever reaching this boundary - see `SegmentsLoadError`
...
export default function SegmentsError({
  ...
  useEffect(() => {
    ...
    posthog.captureException(error, {
      $exception_source: "segments_list_error_boundary",
    ...
    <div className="flex flex-1 items-center justify-center p-4 lg:p-6">
      <Empty className="max-w-2xl border">
        <EmptyHeader>
          ...
          <EmptyTitle>We couldn't load your segments</EmptyTitle>
          <EmptyDescription>
            Something went wrong while building this page. Your segments are

...
export function AutomationsTable({
  ...
  const handleEnable = async (automationId: string) => {
    startTransition(async () => {
      const result = await enableAutomation(automationId, organizationId);
      if (result.success) {
  ...
  const handleDisable = async (automationId: string) => {
    startTransition(async () => {
      const result = await disableAutomation(automationId, organizationId);
      if (result.success) {
  ...
  const handleDuplicate = async (automationId: string) => {
    startTransition(async () => {
      const result = await duplicateAutomation(automationId, organizationId);
      if (result.success) {
      ...
      <AlertDialog onOpenChange={setDeleteDialogOpen} open={deleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete "{automationToDelete?.name}". This

            ...
            <div className="overflow-hidden">
              <div className="flex animate-logo-scroll space-x-8 sm:space-x-12">
                ...
                {techCompanies.map((company, index) => (
                  <Card
                    className="flex h-16 w-40 flex-shrink-0 items-center justify-center border-0 bg-transparent opacity-60 shadow-none transition-opacity duration-300 hover:opacity-100"
                    key={`first-${index}`}
                  >

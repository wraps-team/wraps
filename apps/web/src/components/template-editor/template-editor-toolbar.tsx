...
type ViewMode = "edit" | "preview" | "code" | "chat";
    ...
    <TooltipProvider>
      <div className="flex items-center gap-1 border-b bg-muted/30 px-2 py-1.5">
        ...
        <ToggleGroup
          ...
          variant="outline"
        >
          <ToggleGroupItem aria-label="Edit" className="h-8 w-8 p-0" value="edit">
            <Pencil className="h-3.5 w-3.5" />
          </ToggleGroupItem>
          <ToggleGroupItem aria-label="Preview" className="h-8 w-8 p-0" value="preview">
            <Eye className="h-3.5 w-3.5" />
          </ToggleGroupItem>
          <ToggleGroupItem aria-label="Code" className="h-8 w-8 p-0" value="code">
            <Code2 className="h-3.5 w-3.5" />
          </ToggleGroupItem>
          <ToggleGroupItem aria-label="AI Chat" className="h-8 w-8 p-0" value="chat">
        ...
        <Separator className="mx-1 h-6 hidden md:block" orientation="vertical" />
